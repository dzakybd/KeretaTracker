...
public class Login extends AppCompatActivity {
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (!login_username.isEmpty() && !login_password.isEmpty()) {
                    // login user
                    checkLogin(login_password, login_username);
                } else {
                    // Prompt user to enter credentials
                    Toast.makeText(getApplicationContext(),
                            "Please enter the credentials!", Toast.LENGTH_LONG)
    ...
    private void checkLogin(final String login_username, final String login_password) {
        // Tag used to cancel the request
        String tag_string_req = "req_login";
        ...
        })
        {
            ...
            protected Map<String, String> getParams() {
                ...
                params.put("login_password", login_password);
